{- This file was auto-generated from greenfield/permission/query.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Greenfield.Permission.Query (
...
instance Data.ProtoLens.Message QueryParamsRequest where
  messageName _
    = Data.Text.pack "greenfield.permission.QueryParamsRequest"
...
{- | Fields :
         ...
         * 'Proto.Greenfield.Permission.Query_Fields.params' @:: Lens' QueryParamsResponse Proto.Greenfield.Permission.Params.Params@
         * 'Proto.Greenfield.Permission.Query_Fields.maybe'params' @:: Lens' QueryParamsResponse (Prelude.Maybe Proto.Greenfield.Permission.Params.Params)@ -}
data QueryParamsResponse
  = QueryParamsResponse'_constructor {_QueryParamsResponse'params :: !(Prelude.Maybe Proto.Greenfield.Permission.Params.Params),
...
instance Prelude.Show QueryParamsResponse where
  showsPrec _ __x __s
    = Prelude.showChar
        ...
        (Prelude.showString
           (Data.ProtoLens.showMessageShort __x) (Prelude.showChar '}' __s))
instance Data.ProtoLens.Field.HasField QueryParamsResponse "params" Proto.Greenfield.Permission.Params.Params where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
...
instance Data.ProtoLens.Field.HasField QueryParamsResponse "maybe'params" (Prelude.Maybe Proto.Greenfield.Permission.Params.Params) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _QueryParamsResponse'params
...
instance Data.ProtoLens.Message QueryParamsResponse where
  messageName _
    = Data.Text.pack "greenfield.permission.QueryParamsResponse"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Service.Types.Service Query where
  ...
  type ServicePackage Query = "greenfield.permission"
  type ServiceMethods Query = '["params"]
  packedServiceDescriptor _
    = "\n\
      \\ENQQuery\DC2\134\SOH\n\
      \\ACKParams\DC2).greenfield.permission.QueryParamsRequest\SUB*.greenfield.permission.QueryParamsResponse\"%\130\211\228\147\STX\US\DC2\GS/greenfield/permission/params"
...
packedFileDescriptor
  = "\n\
    \!greenfield/permission/query.proto\DC2\NAKgreenfield.permission\SUB*cosmos/base/query/v1beta1/pagination.proto\SUB\DC4gogoproto/gogo.proto\SUB\FSgoogle/api/annotations.proto\SUB\"greenfield/permission/params.proto\"\DC4\n\
    \\DC2QueryParamsRequest\"R\n\
    \\DC3QueryParamsResponse\DC2;\n\
    \\ACKparams\CAN\SOH \SOH(\v2\GS.greenfield.permission.ParamsR\ACKparamsB\EOT\200\222\US\NUL2\144\SOH\n\
    \\ENQQuery\DC2\134\SOH\n\
    \\ACKParams\DC2).greenfield.permission.QueryParamsRequest\SUB*.greenfield.permission.QueryParamsResponse\"%\130\211\228\147\STX\US\DC2\GS/greenfield/permission/paramsB4Z2github.com/bnb-chain/greenfield/x/permission/typesJ\245\EOT\n\
    ...
    \\f\n\
    \\ENQ\ACK\NUL\STX\NUL\EOT\DC2\ETX\SO\EOTC\n\
    \\DC1\n\
    \\n\
    \\ACK\NUL\STX\NUL\EOT\176\202\188\"\STX\DC2\ETX\SO\EOTC\n\
    \P\n\
