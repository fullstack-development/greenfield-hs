...
module Proto.Greenfield.Sp.Genesis_Fields where
...
spStoragePriceList ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "spStoragePriceList" a) =>
  Lens.Family2.LensLike' f s a
spStoragePriceList
...
storageProviders ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "storageProviders" a) =>
  Lens.Family2.LensLike' f s a
storageProviders = Data.ProtoLens.Field.field @"storageProviders"
vec'spStoragePriceList ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'spStoragePriceList" a) =>
  Lens.Family2.LensLike' f s a
vec'spStoragePriceList
  = Data.ProtoLens.Field.field @"vec'spStoragePriceList"
vec'storageProviders ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'storageProviders" a) =>
  Lens.Family2.LensLike' f s a
vec'storageProviders
