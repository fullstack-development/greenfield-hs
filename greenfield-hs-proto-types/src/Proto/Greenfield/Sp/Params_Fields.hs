...
module Proto.Greenfield.Sp.Params_Fields where
...
depositDenom ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "depositDenom" a) =>
  Lens.Family2.LensLike' f s a
depositDenom = Data.ProtoLens.Field.field @"depositDenom"
minDeposit ::
  forall f s a.
  (Prelude.Functor f,
...
secondarySpStorePriceRatio ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "secondarySpStorePriceRatio" a) =>
  Lens.Family2.LensLike' f s a
secondarySpStorePriceRatio
