...
module Proto.Cosmos.Authz.V1beta1.Genesis_Fields where
...
vec'authorization ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'authorization" a) =>
  Lens.Family2.LensLike' f s a
vec'authorization = Data.ProtoLens.Field.field @"vec'authorization"