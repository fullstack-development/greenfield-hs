...
module Proto.Cosmos.Authz.V1beta1.Tx_Fields where
...
grant ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "grant" a) =>
  Lens.Family2.LensLike' f s a
grant = Data.ProtoLens.Field.field @"grant"
grantee ::
  forall f s a.
...
maybe'grant ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'grant" a) =>
  Lens.Family2.LensLike' f s a
maybe'grant = Data.ProtoLens.Field.field @"maybe'grant"
msgTypeUrl ::
  forall f s a.
  (Prelude.Functor f,
