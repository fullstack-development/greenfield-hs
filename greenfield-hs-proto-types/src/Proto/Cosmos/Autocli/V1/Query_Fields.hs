...
module Proto.Cosmos.Autocli.V1.Query_Fields where
...
moduleOptions ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "moduleOptions" a) =>
  Lens.Family2.LensLike' f s a
moduleOptions = Data.ProtoLens.Field.field @"moduleOptions"
value ::
  forall f s a.
