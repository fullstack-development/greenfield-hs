...
module Proto.Cosmos.Bank.Module.V1.Module_Fields where
...
blockedModuleAccountsOverride ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "blockedModuleAccountsOverride" a) =>
  Lens.Family2.LensLike' f s a
blockedModuleAccountsOverride
  = Data.ProtoLens.Field.field @"blockedModuleAccountsOverride"
vec'blockedModuleAccountsOverride ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'blockedModuleAccountsOverride" a) =>
  Lens.Family2.LensLike' f s a
vec'blockedModuleAccountsOverride
