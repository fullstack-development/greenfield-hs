...
module Proto.Cosmos.Bank.V1beta1.Tx_Fields where
...
useDefaultFor ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "useDefaultFor" a) =>
  Lens.Family2.LensLike' f s a
useDefaultFor = Data.ProtoLens.Field.field @"useDefaultFor"
vec'amount ::
  forall f s a.
  (Prelude.Functor f,
...
vec'useDefaultFor ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'useDefaultFor" a) =>
  Lens.Family2.LensLike' f s a
vec'useDefaultFor = Data.ProtoLens.Field.field @"vec'useDefaultFor"