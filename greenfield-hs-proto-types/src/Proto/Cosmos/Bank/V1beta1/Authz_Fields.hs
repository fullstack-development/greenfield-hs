...
module Proto.Cosmos.Bank.V1beta1.Authz_Fields where
...
vec'allowList ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'allowList" a) =>
  Lens.Family2.LensLike' f s a
vec'allowList = Data.ProtoLens.Field.field @"vec'allowList"
vec'spendLimit ::
  forall f s a.
  (Prelude.Functor f,
