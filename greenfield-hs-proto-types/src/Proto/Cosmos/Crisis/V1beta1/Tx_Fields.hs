...
module Proto.Cosmos.Crisis.V1beta1.Tx_Fields where
...
constantFee ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "constantFee" a) =>
  Lens.Family2.LensLike' f s a
constantFee = Data.ProtoLens.Field.field @"constantFee"
invariantModuleName ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "invariantModuleName" a) =>
  Lens.Family2.LensLike' f s a
invariantModuleName
...
invariantRoute ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "invariantRoute" a) =>
  Lens.Family2.LensLike' f s a
invariantRoute = Data.ProtoLens.Field.field @"invariantRoute"
maybe'constantFee ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'constantFee" a) =>
  Lens.Family2.LensLike' f s a
maybe'constantFee = Data.ProtoLens.Field.field @"maybe'constantFee"
sender ::
  forall f s a.
