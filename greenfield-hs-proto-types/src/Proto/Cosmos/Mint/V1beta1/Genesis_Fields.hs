...
module Proto.Cosmos.Mint.V1beta1.Genesis_Fields where
...
maybe'minter ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'minter" a) =>
  Lens.Family2.LensLike' f s a
maybe'minter = Data.ProtoLens.Field.field @"maybe'minter"
maybe'params ::
  forall f s a.
  (Prelude.Functor f,
...
minter ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "minter" a) =>
  Lens.Family2.LensLike' f s a
minter = Data.ProtoLens.Field.field @"minter"
params ::
  forall f s a.
