{- This file was auto-generated from cosmos/mint/v1beta1/tx.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Cosmos.Mint.V1beta1.Tx (
...
{- | Fields :
         ...
         * 'Proto.Cosmos.Mint.V1beta1.Tx_Fields.authority' @:: Lens' MsgUpdateParams Data.Text.Text@
         * 'Proto.Cosmos.Mint.V1beta1.Tx_Fields.params' @:: Lens' MsgUpdateParams Proto.Cosmos.Mint.V1beta1.Mint.Params@
         * 'Proto.Cosmos.Mint.V1beta1.Tx_Fields.maybe'params' @:: Lens' MsgUpdateParams (Prelude.Maybe Proto.Cosmos.Mint.V1beta1.Mint.Params)@ -}
data MsgUpdateParams
  = MsgUpdateParams'_constructor {_MsgUpdateParams'authority :: !Data.Text.Text,
                                  _MsgUpdateParams'params :: !(Prelude.Maybe Proto.Cosmos.Mint.V1beta1.Mint.Params),
...
instance Data.ProtoLens.Field.HasField MsgUpdateParams "authority" Data.Text.Text where
  fieldOf _
    = (Prelude..)
        ...
        Prelude.id
instance Data.ProtoLens.Field.HasField MsgUpdateParams "params" Proto.Cosmos.Mint.V1beta1.Mint.Params where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
...
instance Data.ProtoLens.Field.HasField MsgUpdateParams "maybe'params" (Prelude.Maybe Proto.Cosmos.Mint.V1beta1.Mint.Params) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _MsgUpdateParams'params
...
instance Data.ProtoLens.Message MsgUpdateParams where
  messageName _
    = Data.Text.pack "cosmos.mint.v1beta1.MsgUpdateParams"
  packedMessageDescriptor _
    = "\n\
      \\SIMsgUpdateParams\DC26\n\
      \\tauthority\CAN\SOH \SOH(\tR\tauthorityB\CAN\210\180-\DC4cosmos.AddressString\DC2>\n\
      \\ACKparams\CAN\STX \SOH(\v2\ESC.cosmos.mint.v1beta1.ParamsR\ACKparamsB\t\200\222\US\NUL\168\231\176*\SOH:4\130\231\176*\tauthority\138\231\176*!cosmos-sdk/x/mint/MsgUpdateParams"
...
instance Data.ProtoLens.Message MsgUpdateParamsResponse where
  messageName _
    = Data.Text.pack "cosmos.mint.v1beta1.MsgUpdateParamsResponse"
  packedMessageDescriptor _
    = "\n\
...
instance Data.ProtoLens.Service.Types.Service Msg where
  ...
  type ServicePackage Msg = "cosmos.mint.v1beta1"
  type ServiceMethods Msg = '["updateParams"]
  packedServiceDescriptor _
    = "\n\
      \\ETXMsg\DC2b\n\
      \\fUpdateParams\DC2$.cosmos.mint.v1beta1.MsgUpdateParams\SUB,.cosmos.mint.v1beta1.MsgUpdateParamsResponse\SUB\ENQ\128\231\176*\SOH"
...
packedFileDescriptor
  = "\n\
    \\FScosmos/mint/v1beta1/tx.proto\DC2\DC3cosmos.mint.v1beta1\SUB\ETBcosmos/msg/v1/msg.proto\SUB\DC1amino/amino.proto\SUB\RScosmos/mint/v1beta1/mint.proto\SUB\DC4gogoproto/gogo.proto\SUB\EMcosmos_proto/cosmos.proto\"\191\SOH\n\
    \\SIMsgUpdateParams\DC26\n\
    \\tauthority\CAN\SOH \SOH(\tR\tauthorityB\CAN\210\180-\DC4cosmos.AddressString\DC2>\n\
    \\ACKparams\CAN\STX \SOH(\v2\ESC.cosmos.mint.v1beta1.ParamsR\ACKparamsB\t\200\222\US\NUL\168\231\176*\SOH:4\130\231\176*\tauthority\138\231\176*!cosmos-sdk/x/mint/MsgUpdateParams\"\EM\n\
    \\ETBMsgUpdateParamsResponse2p\n\
    \\ETXMsg\DC2b\n\
    \\fUpdateParams\DC2$.cosmos.mint.v1beta1.MsgUpdateParams\SUB,.cosmos.mint.v1beta1.MsgUpdateParamsResponse\SUB\ENQ\128\231\176*\SOHB+Z)github.com/cosmos/cosmos-sdk/x/mint/typesJ\214\b\n\
    \\ACK\DC2\EOT\NUL\NUL*\"\n\
    \\b\n\
    ...
    \\t\n\
    \\STX\ETX\SOH\DC2\ETX\ACK\NUL\ESC\n\
    \\t\n\
    \\STX\ETX\STX\DC2\ETX\a\NUL(\n\
    \\t\n\
    \\STX\ETX\ETX\DC2\ETX\b\NUL\RS\n\
    \\t\n\
    \\STX\ETX\EOT\DC2\ETX\t\NUL#\n\
    \1\n\
    \\STX\ACK\NUL\DC2\EOT\f\NUL\DC4\SOH\SUB% Msg defines the x/mint Msg service.\n\
    \\n\
    \\n\
    \\n\
    ...
    \\183\SOH\n\
    \\EOT\ACK\NUL\STX\NUL\DC2\ETX\DC3\STXF\SUB\169\SOH UpdateParams defines a governance operation for updating the x/mint module\n\
    ...
    \g\n\
    \\EOT\EOT\NUL\STX\SOH\DC2\ETX#\STXR\SUBZ params defines the x/mint parameters to update.\n\
    \\n\
