...
module Proto.Cosmos.Crypto.Multisig.V1beta1.Multisig_Fields where
...
extraBitsStored ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "extraBitsStored" a) =>
  Lens.Family2.LensLike' f s a
extraBitsStored = Data.ProtoLens.Field.field @"extraBitsStored"
signatures ::
  forall f s a.
  (Prelude.Functor f,
