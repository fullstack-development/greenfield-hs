...
module Proto.Cosmos.Slashing.V1beta1.Query_Fields where
...
consAddress ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "consAddress" a) =>
  Lens.Family2.LensLike' f s a
consAddress = Data.ProtoLens.Field.field @"consAddress"
info ::
  forall f s a.
...
maybe'valSigningInfo ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'valSigningInfo" a) =>
  Lens.Family2.LensLike' f s a
maybe'valSigningInfo
...
valSigningInfo ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "valSigningInfo" a) =>
  Lens.Family2.LensLike' f s a
valSigningInfo = Data.ProtoLens.Field.field @"valSigningInfo"
vec'info ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'info" a) =>
  Lens.Family2.LensLike' f s a
vec'info = Data.ProtoLens.Field.field @"vec'info"