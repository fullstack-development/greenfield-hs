...
module Proto.Cosmos.Base.Query.V1beta1.Pagination_Fields where
...
countTotal ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "countTotal" a) =>
  Lens.Family2.LensLike' f s a
countTotal = Data.ProtoLens.Field.field @"countTotal"
key ::
  forall f s a.
...
nextKey ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "nextKey" a) =>
  Lens.Family2.LensLike' f s a
nextKey = Data.ProtoLens.Field.field @"nextKey"
offset ::
  forall f s a.
