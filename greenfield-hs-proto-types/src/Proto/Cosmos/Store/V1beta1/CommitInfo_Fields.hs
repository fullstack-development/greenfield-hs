...
module Proto.Cosmos.Store.V1beta1.CommitInfo_Fields where
...
maybe'commitId ::
  ...
  Lens.Family2.LensLike' f s a
maybe'commitId = Data.ProtoLens.Field.field @"maybe'commitId"
maybe'timestamp ::
  forall f s a.
  (Prelude.Functor f,
...
storeInfos ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "storeInfos" a) =>
  Lens.Family2.LensLike' f s a
storeInfos = Data.ProtoLens.Field.field @"storeInfos"
timestamp ::
  forall f s a.
  (Prelude.Functor f,
...
vec'storeInfos ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'storeInfos" a) =>
  Lens.Family2.LensLike' f s a
vec'storeInfos = Data.ProtoLens.Field.field @"vec'storeInfos"
version ::
  forall f s a.
