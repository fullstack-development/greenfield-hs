...
module Proto.Cosmos.Upgrade.V1beta1.Upgrade_Fields where
...
maybe'upgradedClientState ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'upgradedClientState" a) =>
  Lens.Family2.LensLike' f s a
maybe'upgradedClientState
...
upgradedClientState ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "upgradedClientState" a) =>
  Lens.Family2.LensLike' f s a
upgradedClientState
  = Data.ProtoLens.Field.field @"upgradedClientState"
version ::
  forall f s a.
