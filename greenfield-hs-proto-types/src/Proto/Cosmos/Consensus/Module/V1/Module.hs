{- This file was auto-generated from cosmos/consensus/module/v1/module.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Cosmos.Consensus.Module.V1.Module (
        Module()
    ) where
...
{- | Fields :
         ...
         * 'Proto.Cosmos.Consensus.Module.V1.Module_Fields.authority' @:: Lens' Module Data.Text.Text@ -}
data Module
...
instance Data.ProtoLens.Message Module where
  messageName _ = Data.Text.pack "cosmos.consensus.module.v1.Module"
  packedMessageDescriptor _
    = "\n\
      \\ACKModule\DC2\FS\n\
      \\tauthority\CAN\SOH \SOH(\tR\tauthority:0\186\192\150\218\SOH*\n\
...
packedFileDescriptor
  = "\n\
    \'cosmos/consensus/module/v1/module.proto\DC2\SUBcosmos.consensus.module.v1\SUB cosmos/app/v1alpha1/module.proto\"X\n\
    \\ACKModule\DC2\FS\n\
    \\tauthority\CAN\SOH \SOH(\tR\tauthority:0\186\192\150\218\SOH*\n\
    \(github.com/cosmos/cosmos-sdk/x/consensusJ\173\STX\n\
    ...
    \B\n\
    \\STX\EOT\NUL\DC2\EOT\a\NUL\SO\SOH\SUB6 Module is the config object of the consensus module.\n\
    \\n\
    \\n\
    \\n\
