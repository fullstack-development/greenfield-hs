...
module Proto.Cosmos.Evidence.V1beta1.Evidence_Fields where
...
consensusAddress ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "consensusAddress" a) =>
  Lens.Family2.LensLike' f s a
consensusAddress = Data.ProtoLens.Field.field @"consensusAddress"
height ::
  forall f s a.
